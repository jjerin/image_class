...
@Component({
  selector: 'image-class-cats-dogs',
  templateUrl: './image-class-cats-dogs.component.html',
  styleUrls: ['./image-class-cats-dogs.component.css']
})
export class ImageClassCatsDogsComponent implements OnInit {
  ...
  public async ngOnInit(): Promise<void> {
    ...
    this.model = await tf.loadLayersModel('./assets/cats-dogs-model/model-formatted.json')
