...
@Component({
  selector: 'image-class-animals',
  templateUrl: './image-class-animals.component.html',
  styleUrls: ['./image-class-animals.component.css']
})
export class ImageClassAnimalsComponent implements OnInit {
  ...
  class_names: string[] = ['butterfly', 'cat', 'chicken', 'cow', 'dog', 'elephant', 'horse', 'sheep', 'spider', 'squirrel'];
  prediction: string;
  ...
  public async ngOnInit(): Promise<void> {
    ...
    this.model = await tf.loadLayersModel('./assets/animals-model/model-formatted.json')
